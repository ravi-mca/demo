...
import com.favendo.merchant.rest.contextconfig.MerchantContextConfig;
...
@Import({SecurityContextConfig.class, UserServiceContextConfig.class, DataSourceContextConfig.class,
        CommonsContextConfig.class,PropertySourceContextConfig.class, MerchantContextConfig.class})
